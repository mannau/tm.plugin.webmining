...
tm::meta(yahoonews[[1]], "Description") <- 
		paste(substring(tm::meta(yahoonews[[1]], "Description"), 1, 70), "...", sep = "")
tm::meta(yahoonews[[1]], "ID") <- 
		paste(substring(tm::meta(yahoonews[[1]], "ID"), 1, 70), "...", sep = "")
tm::meta(yahoonews[[1]], "Origin") <- 
		paste(substring(tm::meta(yahoonews[[1]], "Origin"), 1, 70), "...", sep = "")
@
<<echo=T, eval=T>>=
tm::meta(yahoonews[[1]])
@
...
<<echo=T, eval=T, fig=T>>=
length(rbloggers)
rbloggers.dates <- do.call(c,lapply(rbloggers, tm::meta, "DateTimeStamp"))
